...
<body>
	...
	<div class="container mt-4">
		...
		if (isset($_POST["submit"])) {
			...
			$status = $_POST['status'];
			$jenisQuery = "UPDATE lamarkerja2 SET 
				Id = '$id',
				Iduser = '$iduser',
				username = '$username',
				Id_formasi = '$id_formasi',
				status = '$status'
				WHERE Id = '$id'";
			mysqli_query($conn, $jenisQuery);
			echo "<script>alert('Data Berhasil Diubah');
			window.location.href = 'adminDataPelamar.php';	
			</script>";
		}
		?>
		...
		<form method="post" action="">
			...
			<table>
				<tr>
					<td>ID USer</td>
					<td><input type="text" name="iduser" value="<?php echo $r['iduser']; ?>" /></td>
				</tr>
				<tr>
					<td>Username</td>
				...
				<tr>
					<td>Formasi</td>
					<td><input type="text" name="id_formasi" value="<?php echo $r['id_formasi']; ?>" /></td>
				</tr>
				<tr>
					<td>Status</td>
